...
<body>
	...
	<div class="container">
		<main role="main" class="pt-5">
			...
			<p>
				Faça <span><b>login</b></span> para acessar e manipular os dados de
					...
					<div class="d-flex justify-content-around w-25">
						<div>
							<a class="btn btn-success ml-3"
								href="../../jsp/authentication/login.jsp" style="width: 10rem">Login</a>
						</div>
						<div>
							<a class="btn btn-dark" href="../../index.jsp"
								style="width: 8rem">Página Inicial</a>
						</div>
					</div>
				</div>
			</section>
